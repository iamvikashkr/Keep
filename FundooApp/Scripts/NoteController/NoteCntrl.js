...
app.controller('NotesController', function ($scope, $mdDialog, $mdSidenav, $window, $http, $filter) {
    ...
    function mapColor() {
        ...
        if (fullurl == "https://localhost:44399/Notes/GetNotes") {
        ...
        else if (fullurl == "https://localhost:44399/Notes/Archive") {
        ...
        else if (fullurl == "https://localhost:44399/Notes/Trash") {
        ...
        else if (fullurl == "https://localhost:44399/Notes/Reminder") {
    ...
    //profile image
    $scope.showPromptUpdate = function (ev) {
        $mdDialog.show({
            controller: DialogController,
            templateUrl: "/Notes/UpdateImage",
    ...
    $scope.uploadImagenew = function (note, ev) {
            ...
            controller: function () {
                ...
                $ctrl.uploadImage = function () {
                    ...
                    if (files.length > 0) {
                        ...
                        data.append('IsTrash', note.IsTrash);
                        var settings =
                            {
                                type: "POST",
    ...
    $scope.rem4 = function (obj, date) {
        debugger;
        var Mode = $scope.update;
        var DD = $filter('date')(date, 'dd MMMM');
